...
public class ArtikCloudSession {
   ...
   //Your device name
    private final static String DEVICE_NAME = "Park System";
 //your registered actions (case sensitive)
    private final static String ACTION_MOTOR_ON = "motor_on";
    private final static String ACTION_MOTOR_OFF = "motor_off";
    private final static String ACTION_GATE_ON = "gate_on";
    private final static String ACTION_GATE_OFF = "gate_off";
...
//each is called whenever we want to send actions
    public void send_action_motor_on() {
        new sendActionInBackground().execute(ACTION_MOTOR_ON);
    }
    public void send_action_motor_off() {
        new sendActionInBackground().execute(ACTION_MOTOR_OFF);
    }
    public void send_action_gate_on() {
        new sendActionInBackground().execute(ACTION_GATE_ON);
    }
    public void send_action_gate_off() {
        new sendActionInBackground().execute(ACTION_GATE_OFF);
    }
